...
public partial class DataOwnerRegistration : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("select userid from otable where userid=@userid", con);
            ...
            cmd = new SqlCommand("insert into otable(name,gender,dob,age,address,emailid,mno,userid,pword,rdate,status) values(@name,@gender,@dob,@age,@address,@emailid,@mno,@userid,@pword,@rdate,@status)", con);
            ...
            cmd.ExecuteNonQuery ();
            cmd.Dispose ();
            Label1 .Text ="Owner Details Successfully Registered......";
        }
        catch (Exception ex)
        {
            Label1.Text = ex.Message;
